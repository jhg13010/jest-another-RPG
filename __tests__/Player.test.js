...
test("gets player's health value", () => {
    ...
    //expects the getHealth function to output a string with the player's health
    //expect.stringContaining piece will look for player.health to be inside the string 
